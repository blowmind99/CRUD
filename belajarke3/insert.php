...
if ($has_error == true) {
    ...
    # code...
    header ("Location:tambah.php"."?". $temp);

} else {
    # code...
    mysqli_query($conn, "INSERT INTO karyawan VALUES('', '".$temp_arr[0]['value']."', '".$temp_arr[1]['value']."', '".$temp_arr[2]['value']."','".$temp_arr[3]['value']."','".$temp_arr[4]['value']."')");
